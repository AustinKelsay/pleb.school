...
const createDraftLessonSchema = z.object({
  ...
  resourceId: z.uuid({ error: 'Invalid resource ID' }).optional(),
  draftId: z.uuid({ error: 'Invalid draft ID' }).optional(),
...
const querySchema = z.object({
  courseDraftId: z.uuid({ error: 'Invalid course draft ID' }).optional()
})
